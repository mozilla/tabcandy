...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\tabcandy on
     Windows, /home/user/dev/tabcandy on Linux) in a file named
     tabcandy@aza.raskin and copy that file to
